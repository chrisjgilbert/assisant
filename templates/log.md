<!--
  ...
  lines — this is the audit trail of how the brain got to its current state.

  Format of each entry:
      ## [YYYY-MM-DD] <verb> | <short description>
  Common verbs: pull (connector → raw), ingest (raw → synthesis), brief
  (daily brief generated), query (ad-hoc question answered). Optionally add a
  detail line or two under an entry.

  The lines below are EXAMPLES — delete them on first real run.
-->
